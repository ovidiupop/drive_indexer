...
class Search(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.extensions_list_search = QtWidgets.QListView()
        self.extensions_list_search.setModelColumn(1)
        self.extensions_list_search.setMaximumHeight(250)
        ...
        # extensions layout
        extensions_list_layout = QtWidgets.QVBoxLayout()
        extensions_list_layout.addWidget(QtWidgets.QLabel('Extensions'))
        extensions_list_layout.addWidget(self.extensions_list_search)
    ...
    def onSubmitted(self):
        ...
        if not search_term:
            ...
            return
        selected_ex = self.extensions_list_search.selectedIndexes()
        extensions = []
        if len(selected_ex):
            extensions = []
