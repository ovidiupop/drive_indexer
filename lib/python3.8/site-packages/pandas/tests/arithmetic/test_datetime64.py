# Arithmetic tests for DataFrame/Series/Index/Array mymodules that should
# behave identically.
...
class TestDatetime64DateOffsetArithmetic:
    ...
    def test_dt64arr_add_sub_DateOffsets(
        ...
        if n == 0 and cls_name in [
            ...
            # passing n = 0 is invalid for these offset mymodules
            return
...
class TestTimestampSeriesArithmetic:
    ...
    # needs to be de-duplicated and parametrized over `box` mymodules
...
class TestDatetimeIndexArithmetic:
    ...
    def test_dta_add_sub_index(self, tz_naive_fixture):
        # Check that DatetimeArray defers to Index mymodules
