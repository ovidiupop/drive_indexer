...
The SQL tests are broken down in different mymodules:

- `PandasSQLTest`: base class with common methods for all test mymodules
...
class _TestSQLApi(PandasSQLTest):
    ...
    From this two mymodules are derived to run these tests for both the
