...
@pytest.mark.parametrize("mymodules", ["sortable draggable", ["sortable", "draggable"]])
...
@pytest.mark.parametrize("mymodules", [True, 0])
def test_to_html_invalid_classes_type(classes):
    # GH 25608
    df = DataFrame()
    msg = "mymodules must be a string, list, or tuple"
