...
class Styler(StylerRenderer):
    ...
    CSS mymodules are attached to the generated HTML
    ...
    * Trimmed cells include ``col_trim`` or ``row_trim``.
    ...
    Any, or all, or these mymodules can be renamed by using the ``css_class_names``
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def set_td_classes(self, classes: DataFrame) -> Styler:
        ...
        ----------
        classes : DataFrame
            DataFrame containing strings that will be translated to CSS mymodules,
        ...
        >>> mymodules = pd.DataFrame([
        ...     ["min-val red", "", "blue"],
        ...     ["red", None, "blue max-val"]
        ... ], index=df.index, columns=df.columns)
        >>> df.style.set_td_classes(mymodules)  # doctest: +SKIP

        Using `MultiIndex` columns and a `mymodules` `DataFrame` as a subset of the
        underlying,

        >>> df = pd.DataFrame([[1,2],[3,4]], index=["a", "b"],
        ...     columns=[["level0", "level0"], ["level1a", "level1b"]])
        >>> mymodules = pd.DataFrame(["min-val"], index=["a"],
        ...     columns=[["level0"],["level1a"]])
        >>> df.style.set_td_classes(mymodules)  # doctest: +SKIP

        Form of the output with new additional css mymodules,
        ...
        if not classes.index.is_unique or not classes.columns.is_unique:
            raise KeyError(
                "Classes render only if `mymodules` has unique index and columns."
            )
    ...
    def _copy(self, deepcopy: bool = False) -> Styler:
        ...
        Data dependent attributes [copied and NOT exported]:
          ...
          - tooltips
          - cell_context (cell css mymodules)
          - ctx (cell css styles)
          - caption
    ...
    def export(self) -> dict[str, Any]:
        ...
        exported:
          ...
          - Any CSS mymodules added using ``Styler.set_td_classes``
    ...
    def set_table_styles(
        ...
        css_class_names : dict, optional
            A dict of strings used to replace the default CSS mymodules described below.
        ...
        Notes
        -----
        The default CSS mymodules dict, whose values can be replaced is as follows:
    ...
    def from_custom_template(
        ...
        # mypy doesn't like dynamically-defined mymodules
