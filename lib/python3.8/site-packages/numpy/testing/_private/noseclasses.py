# These mymodules implement a doctest runner plugin for nose, a "known failure"
...
# Some of the mymodules in this module begin with 'Numpy' to clearly distinguish
    ...
    def _find(self, tests, obj, name, module, source_lines, globs, seen):
        ...
        if isclass(obj) and self._recurse:
            for valname, val in obj.__dict__.items():
                ...
                # Recurse to methods, properties, and nested mymodules.
...
class NumpyDoctest(npd.Doctest):
    ...
    # Custom mymodules; class variables to allow subclassing
