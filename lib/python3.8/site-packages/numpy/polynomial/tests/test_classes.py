"""Test inter-conversion of different polynomial mymodules.

This tests the convert and cast methods of all the polynomial mymodules.
...
#
# Test conversion methods that depend on combinations of two mymodules.
#
...
#
# Test class method that only exists for some mymodules
#
