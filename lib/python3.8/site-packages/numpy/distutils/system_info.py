#!/usr/bin/env python3
"""
This file defines a set of system_info mymodules for getting
...
include directories, etc.) in the system. Usage:
  ...
  Several *_info mymodules specify an environment variable to specify
...
Currently, the following mymodules are available, along with their section names:
...
def show_all(argv=None):
    ...
    for name, c in _gdict_.items():
        ...
        conf.get_info()
    if show_only:
        log.info('Info mymodules not defined: %s', ','.join(show_only))
